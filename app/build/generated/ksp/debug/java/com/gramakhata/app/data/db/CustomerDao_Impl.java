...
public final class CustomerDao_Impl implements CustomerDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfDeleteCustomersByUserId;
  ...
  public CustomerDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCustomer = new EntityInsertionAdapter<Customer>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `customers` (`id`,`userId`,`name`,`mobile`,`photoUri`,`shopName`,`totalCredit`,`totalPaid`,`createdAt`,`lastUpdated`,`isSettled`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(6, entity.getShopName());
        statement.bindDouble(7, entity.getTotalCredit());
        statement.bindDouble(8, entity.getTotalPaid());
    ...
    this.__updateAdapterOfCustomer = new EntityDeletionOrUpdateAdapter<Customer>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `customers` SET `id` = ?,`userId` = ?,`name` = ?,`mobile` = ?,`photoUri` = ?,`shopName` = ?,`totalCredit` = ?,`totalPaid` = ?,`createdAt` = ?,`lastUpdated` = ?,`isSettled` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteCustomersByUserId = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "DELETE FROM customers WHERE userId = ?";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object deleteCustomersByUserId(final String userId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteCustomersByUserId.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteCustomersByUserId.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public LiveData<List<Customer>> getAllActiveCustomers(final String userId) {
    final String _sql = "SELECT * FROM customers WHERE userId = ? AND isSettled = 0 ORDER BY (totalCredit - totalPaid) DESC";
      ...
      public List<Customer> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new Customer(_tmpId,_tmpUserId,_tmpName,_tmpMobile,_tmpPhotoUri,_tmpShopName,_tmpTotalCredit,_tmpTotalPaid,_tmpCreatedAt,_tmpLastUpdated,_tmpIsSettled);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public LiveData<List<Customer>> getAllCustomers(final String userId) {
    final String _sql = "SELECT * FROM customers WHERE userId = ? ORDER BY (totalCredit - totalPaid) DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
    return __db.getInvalidationTracker().createLiveData(new String[] {"customers"}, false, new Callable<List<Customer>>() {
      ...
      public Customer call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _tmp = _cursor.getInt(_cursorIndexOfIsSettled);
            _tmpIsSettled = _tmp != 0;
            _result = new Customer(_tmpId,_tmpUserId,_tmpName,_tmpMobile,_tmpPhotoUri,_tmpShopName,_tmpTotalCredit,_tmpTotalPaid,_tmpCreatedAt,_tmpLastUpdated,_tmpIsSettled);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public LiveData<List<Customer>> searchCustomers(final String userId, final String query) {
    final String _sql = "SELECT * FROM customers WHERE userId = ? AND name LIKE '%' || ? || '%' AND isSettled = 0 ORDER BY (totalCredit - totalPaid) DESC";
  ...
  @Override
  public LiveData<Double> getTotalDues(final String userId) {
    final String _sql = "SELECT SUM(totalCredit - totalPaid) FROM customers WHERE userId = ? AND isSettled = 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
  ...
  @Override
  public LiveData<Integer> getActiveDebtorCount(final String userId) {
    final String _sql = "SELECT COUNT(*) FROM customers WHERE userId = ? AND isSettled = 0 AND (totalCredit - totalPaid) > 0";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    _statement.bindString(_argIndex, userId);
