...
class CustomerAdapter(
    ...
    inner class CustomerViewHolder(private val binding: ItemCustomerBinding) :
            ...
            if (!customer.photoUri.isNullOrBlank()) {
                try {
                    ...
                    if (file.exists()) {
                        ...
                        binding.cardInitials.visibility = android.view.View.GONE
        ...
        private fun showInitials(customer: Customer) {
            binding.cardInitials.visibility = android.view.View.VISIBLE
